...
Revision ID: f52a70d663d2
Revises: 
Create Date: 2018-02-11 21:28:21.306051
...
def upgrade():
    ...
    op.create_index(op.f('ix_blood_sugar_month_uuid'), 'blood_sugar_month', ['uuid'], unique=False)
